...
class ResultsStorage:
    ...
    def append_frame_to_results(
        ...
        self.db.append_frame_to_results(
            analysis_id, frame_data, total_frames, processed_count=processed_count
        )
    ...
    def append_frames_to_results(
        ...
        self.db.append_frames_to_results(
            analysis_id, frames, total_frames, processed_count
        )
    ...
    def finalize_results(
        ...
        self.db.finalize_results(
            analysis_id, results, skip_frame_upsert=skip_frame_upsert
        )
...
class AnalysisStorage:
    ...
    def list_analyses(
        ...
        return self.db.list_analyses(
            video_id=video_id, status=status, limit=limit, offset=offset
        )
